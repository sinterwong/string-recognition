...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x, nl=17):
        ...
        out2 = self.model.classifier1(c2)
        out3 = self.model.classifier1(c3)
        out4 = self.model.classifier1(c4)
        out5 = self.model.classifier1(c5)
        out6 = self.model.classifier1(c6)
        out7 = self.model.classifier1(c7)
